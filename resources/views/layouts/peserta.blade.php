            ...
            <div class="w-full ml-64">
                <div class="bg-white py-4 px-4">
                    @include('layouts.partials.header')
                        <form method="GET" action="{{ route('peserta') }}" class="flex gap-4 w-full m-0 items-center">
                            <div class="flex flex-row justify-between px-4 w-full max-w-[480px]">
                ...
                <div class="grid grid-cols-3 gap-4 mt-16 mx-[24px]">
                    ...
                    <a href="{{ route('profile', ['id' => $user->id]) }}">
                        <div class="w-full flex flex-row items-center gap-2 my-7 bg-white rounded shadow relative p-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="text-sm text-gray-600"><strong>Asal Sekolah:</strong> {{ $user->asal_sekolah }}</p>
                            </div>
                        </div>
                    </a>
                    @endforeach
