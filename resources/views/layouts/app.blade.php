...
<body>
    <div id="app">
        <header class="bg-blue-600 p-4 text-white flex items-center justify-between">
            <a href="http://127.0.0.1:8000/dashboard"><div class="text-lg font-semibold">Trello Clone</div></a>
            <div class="flex items-center space-x-4">
                @auth
                    ...
                    <div class="relative">
                        ...
                        <label for="user-menu-toggle" class="bg-blue-700 px-3 py-1 rounded text-sm hover:bg-blue-800 cursor-pointer">
                            {{ Auth::user()->name }} ▾
                        </label>
                        <div class="absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg hidden peer-checked:block">
                            ...
                            data.forEach(user => {
                                ...
                                if (!isUserAlreadySelected(user.id)) {
                                    ...
                                    li.addEventListener('click', function () {
                                        addParticipant(user.id, user.name, user.asal_sekolah);
                                        searchInput.value = '';
